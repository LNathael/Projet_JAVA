...
public class CalendrierDAO {
    ...
    String query = "SELECT c.id AS calendrier_id, c.debut, c.fin, c.lieu, a.id AS activite_id, a.nom, a.age_min, a.age_max, a.description FROM calendrier c JOIN activites a ON c.activite_id = a.id WHERE DATE(c.debut) = ?";
